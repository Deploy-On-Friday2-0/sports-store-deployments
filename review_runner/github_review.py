...
async def _validate_workflow_authorization(
    ...
    if (
        ...
        or run.get("path") != ".github/workflows/helm.yml"
    ...
    base_definition, head_definition = await asyncio.gather(
        github.get_repository_file(
            inputs.repository, ".github/workflows/helm.yml", inputs.base_sha
        ),
        github.get_repository_file(
            head_repository, ".github/workflows/helm.yml", inputs.head_sha
        ),
    )
